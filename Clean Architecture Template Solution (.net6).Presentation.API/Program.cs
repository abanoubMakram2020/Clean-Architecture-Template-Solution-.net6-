...
using Clean_Architecture_Template_Solution__.net6_.Infrastructure;
using Clean_Architecture_Template_Solution__.net6_.Infrastructure.DependencyResolution;
